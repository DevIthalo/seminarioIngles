...
var ithalocontent = 'Method name (same as __func__.__name__); __module__ is the name of the module the <font color="#FFD700">method</font> was defined in, or <font color="#FFD700">None</font> if unavailable.<br>Methods also support <font color="#00FF00" title="Gerúndio">accessing</font> (but not <font color="#00FF00" title="Gerúndio">setting</font>) the arbitrary <font color="#FFD700">function attributes</font> on the <font color="#00FF00" title="Gerúndio">underlying</font> function object.<br>User-defined method objects <font color="#FF0000">may</font> be created when <font color="#00FF00" title="Gerúndio">getting</font> an attribute of a <font color="#FFD700">class</font> (perhaps via an instance of that class), if that attribute is a user-defined function object or a class method object.<br>When an <font color="#FFD700">instance</font> method object is created by <font color="#00FF00" title="Gerúndio">retrieving</font> a user-defined function object from a class via one of its instances, its <font color="#FFD700">__self__</font> attribute is the instance, and the method object is said to be bound. The new method’s __func__ attribute is the original function object.<br>When an instance method object is created by <font color="#00FF00" title="Gerúndio">retrieving</font> a class method object from a class or instance, its __self__ attribute is the class itself, and its __func__ attribute is the function object <font color="#00FF00" title="Gerúndio">underlying</font> the class method.<br>When an instance method object is called, the <font color="#00FF00" title="Gerúndio">underlying</font> function (__func__) is called, <font color="#00FF00" title="Gerúndio">inserting</font> the class instance (__self__) in front of the argument list. For instance, when C is a class which contains a definition for a function f(), and x is an instance of C, <font color="#00FF00" title="Gerúndio">calling</font> x.f(1) is equivalent to <font color="#00FF00" title="Gerúndio">calling</font> C.f(x, 1).<br>When an instance method object is derived from a class method object, the “class instance” stored in __self__ will actually be the class itself, so that <font color="#00FF00" title="Gerúndio">calling</font> either x.f(1) or C.f(1) is equivalent to <font color="#00FF00" title="Gerúndio">calling</font> f(C,1) where f is the <font color="#00FF00" title="Gerúndio">underlying</font> function.'
var ithalocontent2 = 'Note that the transformation from function object to instance method object happens each time the attribute is retrieved from the instance. In some cases, a fruitful optimization is to assign the attribute to a local variable and call that local variable. Also notice that this transformation only happens for user-defined functions; other callable objects (and all non-callable objects) are retrieved without transformation. <font color="#00FF00">It is</font> also important to note that user-defined functions which <font color="#00FF00">are</font> attributes <font color="#00FF00">of</font> a class instance are not converted to bound methods; this only happens when the function <font color="#00FF00">is an</font> attribute of the class.<br><strong>Generator functions</strong><br>A function or method which uses the yield statement (see section The yield statement) is called a generator function. Such a function, when called, always returns an iterator object which <font color="#FF0000">can</font> be used to execute the body <font color="#00FF00">of the</font> function: calling the <font color="#00FF00">iterator’s</font> iterator.__next__() method <font color="#FF0000">will</font> cause the function to execute until it provides a value <font color="#00FF00" title="Gerúndio">using</font> the yield statement. When the function executes a return statement or falls off the end, a StopIteration exception is raised and the iterator will have reached the end of the set of values to be returned.<br><strong>Coroutine functions</strong><br>A function or method which is defined <font color="#00FF00" title="Gerúndio">using</font> async def is called a coroutine function. Such a function, when called, returns a coroutine object. It <font color="#FF0000">may</font> contain await expressions, as well as async with and async for statements. See also the Coroutine Objects section.'
var ithalocontent3 = '<strong>Built-in functions</strong><br>A built-in function object is a wrapper around a C function. Examples of built-in functions are <font color="#FFD700">len()</font> and math.sin() (math is a standard built-in module). The number and type of the <font color="#FFD700">arguments</font> are determined by the C function. Special <font color="#00FF00">read</font>-only attributes:<br>__doc__ is the function’s documentation string, or None if unavailable; __name__ is the function’s name; __self__ is set to None (but see the next item); __module__ is the name of the module the function was defined in or None if unavailable.<Br><strong>Built-in methods</strong><br>This is really a different disguise of a built-in function, this time <font color="#00FF00" title="Gerúndio">containing</font> an object passed to the C function as an implicit extra argument. An example of a built-in method is alist.append(), <font color="#00FF00" title="Gerúndio">assuming</font> alist is a list object. In this case, the special read-only attribute __self__ is set to the object denoted by alist.<br><strong>Classes</strong><br>Classes are callable. These objects normally act as factories for new instances of themselves, but variations are possible for class types that override __new__(). The arguments of the call are passed to __new__() and, in the typical case, to __init__() to initialize the new instance.<br><strong>Class Instances</strong><br>Instances of arbitrary classes <font color="#FF0000">can</font> be made callable by <font color="#00FF00" title="Gerúndio">defining</font> a __call__() method in their class.'
var ithalocontent4 = '<Strong>Modules</Strong><br><font color="#FFD700">Modules</font> are a basic organizational unit of Python code, and are created by the <font color="#FFD700">import system</font> as invoked either by the import statement, or by <font color="#00FF00" title="Gerúndio">calling</font> functions such as <font color="#FFD700">importlib.import_module()</font> and built-in __import__(). A module object has a namespace implemented by a dictionary object (this is the dictionary referenced by the __globals__ attribute of functions defined in the module). Attribute references are translated to lookups in this dictionary, e.g., m.x is equivalent to m.__dict__["x"]. A module object does not contain the code object used to initialize the module (since it isn’t needed once the initialization is done).<br>Attribute assignment updates the module’s namespace dictionary, e.g., m.x = 1 is equivalent to m.__dict__["x"] = 1.<br>Predefined (writable) attributes:<br>__name__<br>The module’s name.<br>__doc__<br>The module’s documentation string, or None if unavailable.<br>__file__<br>The pathname of the file from which the module was loaded, if it was loaded from a file. The __file__ attribute <font color="#FF0000">may</font> be <font color="#00FF00" title="Gerúndio">missing</font> for certain types of modules, such as C modules that are statically linked into the interpreter. For extension modules loaded dynamically from a shared library, it’s the pathname of the shared library file.<br>__annotations__<br>A <font color="#FFD700">dictionary</font> <font color="#00FF00" title="Gerúndio">containing</font> variable annotations collected <font color="#00FF00" title="Gerúndio">during</font> module body execution.'
var italoheader = '<br>Methods, instance, classes, function & Modules'

var pedrotitle = 'PEDRO'
var pedrocontent = '<strong>Custom class</strong><br><font color="#00FF00" title="Grupo Nominal">Custom class types</font> typically created by <font color="#00FF00" title="Grupo Nominal">class definitions</font>.When the <font color="#00FF00" title="Grupo Nominal">attribute name</font> is not found there, the <font color="#00FF00" title="Grupo Nominal">attribute search</font> continues in the <font color="#00FF00" title="Grupo Nominal">base classes</font>.When a <font color="#00FF00" title="Grupo Nominal">class attribute reference</font> (to a C class, say) would produce a <font color="#00FF00" title="Grupo Nominal">class method object</font>, it is transformed into an <font color="#00FF00" title="Grupo Nominal">instance method object</font> whose _self_ attribute is C. When it would produce a <font color="#00FF00" title="Grupo Nominal">static method object</font>, it is transformed into the object encapsulated by the static method object.<br>Class attribute assignments update the class dictionary, never the dictionary of a base class.<br><strong>Class Instance</strong><br>A class instance has a <font color="#FFD700">namespace</font> implemented as a <font color="#FFD700">dictionary</font> that is the first place attribute references are looked up.When an <font color="#FFD700">attribute</font> is not found there, and the instance\'s class has an <font color="#FFD700">attribute</font> with that name, the search continues with the class\'s attributes.If a class attribute is found that is a user-defined function object, it is transformed into an instance method object whose _self_attribute is the instance.<br><strong>Code objects</strong><br>Code objects represent compiled executable Python code. Unlike function objects, code objects are immutable and do not contain references directly or indirectly to mutable objects.'
var pedroheader = '<br>Custom class, instance class & object code'

var wesleytitle = 'WESLEY'
var wesleycontent = '<strong>Frame Objects</strong><br>Frame objects represent execution frames. They <font color="#FF0000">may</font> occur in traceback objects (see below), and are also passed to registered trace functions.<br>Special read-only attributes:   f_back , none, f_code, f_locals, f_globals, f_builtins, f_lasti<br>Special writable attributes: f_trace, f_trace False, f_trace_opcodes True, f_lineno<br><strong>frame.clear()</strong><br>This method clears all references to local <font color="#FFD700">variables</font> held by the frame. Also, if the frame belonged to a generator, the generator is finalized. This helps break reference cycles <font color="#00FF00" title="Gerúndio">involving</font> frame objects (for example when <font color="#00FF00" title="Gerúndio">catching</font> an exception and <font color="#00FF00" title="Gerúndio">storing</font> its traceback for later use).<br><strong>Traceback objects</strong><br>Traceback objects represent a <font color="#FFD700">stack trace</font> of an exception. A traceback object is implicitly created when an exception occurs, and <font color="#FF0000">may</font> also be explicitly created by <font color="#00FF00" title="Gerúndio">calling</font> types.TracebackType.<br><strong>Slice objects</strong><br>Slice objects are used to represent slices for <font color="#FFD700">getitem()</font> methods. They are also created by the built-in slice() function.<br>Special read-only attributes: start is the lower bound; stop is the upper bound; step is the step value; each is None if omitted. These attributes <font color="#FF0000">can</font> have any type.'
